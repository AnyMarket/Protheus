...
------------------------------------------------------------------------------------------------------------
*/
User Function ESTCA007(cJson)
	Local oPedido := nil
	
	cJson := '{"type" : "ORDER", "content" : {"id":"2712", "oi":"99999."}}' 
	
	//RPCSetType(3)
	//PREPARE ENVIRONMENT EMPRESA '99' FILIAL '01' 
	
//	If ValType(cJson) != 'C' .OR. Empty(cJson)
//		Return .F.
//	EndIf 
	...
	ElseIf cStatPed == "PAID_WAITING_DELIVERY" //Pedido pendente
		If CriaPedMP(oPedido)
			CriaCliente(oPedido)
			CriaPedido(oPedido) //Apenas para testes
		EndIf
